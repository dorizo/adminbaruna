...
class Role extends CI_Controller {
	...
	public function detail($id){
        ...
        $data['permission'] = $this->db->query("select * from permission where permissionCode NOT IN (select permissionCode from role_permission WHERE roleCode = '".$id."' and deleteAt IS NULL) order by description ASC")->result();
